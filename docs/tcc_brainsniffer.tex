...
O comando \texttt{evaluate-pk} reaproveita as janelas e as predições dos mesmos benchmarks, sem retreino, e grava \texttt{pk\_*.json}; os intervalos vêm de reamostragem de casos ($B=1.000$, seed 42), na mesma unidade agrupada do bootstrap \cite{brainsnifferArtefatos,smith1996}.
