...
A análise por zona estratifica essas mesmas faixas pelo BIS verdadeiro: por zona, $n$, MAE, RMSE, viés e recall (fração com faixa predita correta), além da matriz de confusão $4\times4$ em ordem profunda--geral--leve--acordado. Um recorte exploratório BIS$<20$, subset da profunda, sinaliza risco de padrão isoelétrico/supressão de surtos, sem ser quinta classe ou detector validado. O comando \texttt{evaluate-zones} reaproveita janelas e predições dos mesmos benchmarks, sem retreino, nos quatro relatórios \texttt{zone\_*.json} em \artefato{reports/} \cite{brainsnifferArtefatos}.
...
\subsection{Precisão por zona BIS verdadeira}

O erro se distribui de forma desigual entre zonas. A Tabela~\ref{tab:zonas} e a Figura~\ref{fig:zones} estratificam pelo BIS verdadeiro nos mesmos benchmarks; BIS$<20$ é subset exploratório da profunda. Fontes: os quatro relatórios \texttt{zone\_*.json} em \artefato{reports/} \cite{brainsnifferArtefatos}.
...
\footnotesize
\caption{MAE, viés e recall por zona BIS verdadeira (recall = fração com faixa correta). BIS$<20$ é subset da profunda. Mesmos 5 Figshare e 15 VitalDB anteriores.}
\label{tab:zonas}
\begin{tabular}{llrrrr}
\hline
Conjunto & Zona (BIS) & $n$ & MAE & Viés & Recall\\
\hline
Figshare ativo & profunda 0--40 & 1.773 & 5,64 & $+4{,}91$ & 0,587\\
Figshare ativo & geral 40--60 & 2.584 & 5,53 & $+1{,}02$ & 0,638\\
Figshare ativo & leve 60--80 & 592 & 11,20 & $+0{,}26$ & 0,414\\
Figshare ativo & acordado 80--100 & 574 & 13,73 & $-12{,}45$ & 0,517\\
Figshare misto & profunda 0--40 & 1.773 & 6,24 & $+5{,}82$ & 0,563\\
Figshare misto & geral 40--60 & 2.584 & 5,31 & $+1{,}35$ & 0,631\\
Figshare misto & leve 60--80 & 592 & 11,42 & $+1{,}92$ & 0,370\\
Figshare misto & acordado 80--100 & 574 & 9,37 & $-5{,}60$ & 0,714\\
VitalDB ativo & profunda 0--40 & 14.111 & 17,95 & $+17{,}34$ & 0,452\\
VitalDB ativo & geral 40--60 & 21.580 & 8,42 & $-6{,}78$ & 0,421\\
VitalDB ativo & leve 60--80 & 2.214 & 15,94 & $-15{,}22$ & 0,190\\
VitalDB ativo & acordado 80--100 & 825 & 13,71 & $-12{,}61$ & 0,448\\
VitalDB misto & profunda 0--40 & 14.111 & 10,03 & $+8{,}06$ & 0,534\\
VitalDB misto & geral 40--60 & 21.580 & 6,75 & $-5{,}06$ & 0,645\\
VitalDB misto & leve 60--80 & 2.214 & 15,54 & $-14{,}91$ & 0,178\\
VitalDB misto & acordado 80--100 & 825 & 14,05 & $-13{,}11$ & 0,425\\
\hline
\end{tabular}
\end{table}

No Figshare, sem BIS$<20$ ($n=0$), a zona leve é a mais difícil (MAE $\approx 11$, recall $0{,}37$--$0{,}41$); o ganho do misto concentra-se no acordado (MAE 13,73 para 9,37; recall 0,517 para 0,714). No VitalDB, o ativo colapsa nas extremidades: profunda com MAE 17,95 (viés $+17{,}34$) e 12.214 das 21.580 janelas gerais preditas como profundas. No subset BIS$<20$ ($n=2.301$), MAE 60,73 no ativo contra 12,15 no misto; profunda vai a 10,03 e geral a 6,75 (recall 0,645), mas leve (15,54) e acordado (14,05) não melhoram. Pearson intrafaixa não conduz a leitura \cite{brainsnifferArtefatos}.

\begin{figure}[tbp]
\centering
\includegraphics[width=0.9\columnwidth]{figures/zone_accuracy.pdf}
\caption{MAE por zona BIS verdadeira (Figshare 5/5.523; VitalDB 15/38.730), ativo vs misto. Rótulos $n$ por zona. No VitalDB, o subset BIS$<20$ ($n=2.301$) tem MAE 60,7 no ativo vs 12,2 no misto \cite{brainsnifferArtefatos}.}
\label{fig:zones}
\end{figure}
...
A leitura por zona mostra onde o agregado engana: o MAE global 12,43 do ativo no VitalDB combina zona geral razoável (8,42) com colapso na profunda (17,95) e no subset isoelétrico (60,73). A melhora do misto é desigual --- profunda e geral melhoram, leve e acordado não --- e, como o benchmark é histórico e reutilizado, gera hipótese para coorte travada, não evidência confirmatória \cite{brainsnifferArtefatos,tripodai}.
